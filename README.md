...
## Описание российских сервисов
  ...
  10. **Yandex Static website hosting** — это сервис, позволяющий разместить свой статический сайт в Object Storage. Статический сайт строится на клиентских технологиях, таких как HTML, CSS и JavaScript. Также используется для переадресации всех запросов и условной переадресации запросов.
